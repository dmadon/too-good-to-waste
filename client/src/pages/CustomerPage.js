...
const CustomerPage = () => {
    ...
    return (
        <div>
            <Heading fontFamily='Pacifico' color='#3C2317' textShadow='0 0 4px #B4CDE6' textAlign={'center'} mt={5} mb={4}>Pick Your Boxes!</Heading>
            ...
            <UnorderedList listStyleType={'none'}>
                <Box border='2px' bordercolor='#3C2317' borderRadius='6px' mr={4} p={3} mb={4} className="box-type">
                    <ListItem fontSize={'3xl'} fontFamily='Pacifico' color='#F5EFE6'>Produce Box</ListItem>
                        <Text fontSize={'16px'} fontFamily='Rubik' color='#040303'>An assortment of very ripe fruits and vegetables.</Text>
